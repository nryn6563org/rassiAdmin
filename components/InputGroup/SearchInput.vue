...
.suggestions-list {
  @apply absolute top-[100%] left-0 min-w-[450px] min-h-[300px] border-[1px] border-[#e3e3e3] bg-white list-none mt-1 overflow-y-auto z-[100] shadow-[0_4px_6px_rgba(0,0,0,0.1)] rounded-[6px]
}
.suggestions-list li {
