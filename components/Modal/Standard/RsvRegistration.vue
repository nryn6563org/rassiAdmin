        ...
        <div class="cho_pp">
          ...
          <div class="cho_input">
            <div>
              ...
              <input type="number" step="0.01" placeholder="00.00" class="custom-text-input" style="width: 90px" v-model="rsvRate" :disabled="!isBuyRsvMode || buyStandard === 'price'" />
              <label>%</label>
            </div>
          </div>
          ...
          <div>
            <div class="check">
              <label for="checkTargetComment" class="custom-checkbox-label">
                <input type="checkbox" id="checkTargetComment" class="custom-checkbox-input" v-model="useTargetComment" :disabled="!isTargetStopMode" />
                <span class="custom-checkbox-box"></span>
                <span class="custom-checkbox-txt">목표가 매도 코멘트 :</span>
              </label>
            </div>
            <div class="comment">
              <input type="text" class="custom-text-input" placeholder="목표가 매도 알림과 제시될 한 줄 코멘트를 작성해 주세요." style="width: 708px" v-model="targetCommentText" :disabled="!useTargetComment || !isTargetStopMode" />
          ...
          <div>
            <div class="check">
              <label for="checkStopComment" class="custom-checkbox-label">
                <input type="checkbox" id="checkStopComment" class="custom-checkbox-input" v-model="useStopComment" :disabled="!isTargetStopMode" />
                <span class="custom-checkbox-box"></span>
                <span class="custom-checkbox-txt">손절가 매도 코멘트 :</span>
              </label>
            </div>
            <div class="comment">
              <input type="text" class="custom-text-input" placeholder="손절가 매도 알림과 제시될 한 줄 코멘트를 작성해 주세요." style="width: 708px" v-model="stopCommentText" :disabled="!useStopComment || !isTargetStopMode" />
            </div>
          </div>
        </div>
      </section>
