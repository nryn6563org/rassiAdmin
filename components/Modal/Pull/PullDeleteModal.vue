<template>
  <div id="PullDelete">
    <div class="suggestion">
      <section>
        <strong>종목추천 풀 삭제를 하시겠습니까?</strong>
        <div class="txt">
          <span class="caution">선택하신 종목추천 풀이 삭제됩니다.</span>
          <span>삭제 시 복구가 불가능하므로 신중하게 삭제해 주세요.</span>
          <span>(보유중인 종목이 있는 경우, 또는 마지막 풀의 경우 삭제가 불가능합니다.)</span>
        </div>
      </section>
    </div>
