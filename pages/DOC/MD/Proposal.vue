    ...
    try {
      if (process.server) {
        ...
        proposalHtml = await new Promise((resolve) => {
          https.get('https://tradingpoint.co.kr/trading/document/alphaquant.do', (res) => {
            let data = ''
        ...
        const response = await window.fetch('https://tradingpoint.co.kr/trading/document/alphaquant.do')
