    ...
    try {
      if (process.server) {
        ...
        contractHtml = await new Promise((resolve) => {
          https.get('https://tradingpoint.co.kr/trading/contract/0000336255@nv.do', (res) => {
            let data = ''
        ...
        const response = await window.fetch('https://tradingpoint.co.kr/trading/contract/0000336255@nv.do')
